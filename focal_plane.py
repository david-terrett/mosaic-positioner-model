...
#        self._types = [3,5,2,3,5,2,3,1,0,1,2,5,3,2,5,3,2,1,1,  # 19
#                       2,3,5,2,3,5,2,3,1,5,3,2,5,3,2,5,3,0,    # 18
#                       2,3,5,2,3,5,2,3,1,5,3,2,5,3,2,5,3,0,    # 18
#                       3,5,2,3,5,2,3,1,2,1,2,5,3,2,5,3,2,1,1,  # 19
#                       3,5,2,3,5,2,3,1,2,1,2,5,3,2,5,3,2,1,1,  # 19
#                       2,3,5,2,3,5,2,3,1,5,3,2,5,3,2,5,3,0,    # 18
#                       2,3,5,2,3,5,2,3,1,5,3,2,5,3,2,5,3,0,    # 18
#                       3,5,2,3,5,2,3,1,0,2,5,3,2,5,3,2,1,      # 17
#                       3,5,2,3,5,2,3,1,0,2,5,3,2,5,3,2,1,      # 17
...
# Updated geometry to match CAD representation. Updated field mapping to swith to VIS+VISHR
