...
extern "C" {
    ...
    // point new function
    PyObject* point_new(PyTypeObject* type, PyObject*, PyObject*) {
    ...
    // point init function
    int point_init(PointObject* self, PyObject* args, PyObject*) {
        double x, y;
    ...
    PyObject* polygon_new(PyTypeObject* type, PyObject*, PyObject*) {
    ...
    void polygon_dealloc(PolygonObject* self) {
        delete(self->polygon);
        Py_TYPE(self)->tp_free((PyObject*)self);
    }

    // polygon append method
    PyObject* polygon_append(PolygonObject* self, PyObject* p) {
    ...
    PyObject* polygon_x(PolygonObject* self, PyObject*) {
        auto x = PyList_New(0);
    ...
    PyObject* polygon_y(PolygonObject* self, PyObject*) {
        auto y = PyList_New(0);
        for (auto& p: self->polygon->outer() ) {
    ...
    PyObject* polygon_points(PolygonObject* self, PyObject*) {
    ...
    // Intersects function
    PyObject* intersects(PyObject*, PyObject* args) {
        PolygonObject *p1, *p2;
        if (!PyArg_ParseTuple(args, "OO", &p1, &p2)) return nullptr;
        bool result(false);
